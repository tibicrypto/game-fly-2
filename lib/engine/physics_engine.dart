...
class PhysicsEngine {
  ...
  // Plane hitbox dimensions
  static const double planeWidth = 50.0;
  static const double planeHeight = 30.0;
  ...
  void update(double deltaTime) {
    ...
    if (!isRefueling) {
      double consumption =
          planeStats.fuelEfficiency * GameConfig.fuelBurnRate * deltaTime;
      fuel -= consumption;
      fuel = max(fuel, 0.0);
    }
